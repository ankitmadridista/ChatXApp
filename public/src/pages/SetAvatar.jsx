...
const SetAvatar = () => {
    ...
    // Function to encode SVG string into base64
    ...
    const setProfilePicture = async () => {
        if (selectedAvatar === undefined) {
            ...
            if (data.isSet) {
                ...
                toast.error("Error setting avatar. Please try again in sometime.", toastOptions);
            }
        }
    };
        ...
        const fetchAvatars = async () => {
            ...
            for (let i = 0; i < 3; i++) {
                try {
                    ...
                    const base64Svg = encodeSvgToBase64(svgMarkup);
                    data.push(base64Svg);
                } catch (error) {
